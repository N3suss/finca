...
$title = "Administrar Opciones de Producción Agrícola";
...
<main class="main-content">
    <div class="page-header">
        ...
        <div class="page-header">
        <h1 class="page-title"><i class="fas fa-cog"></i> Administrar Opciones de Producción</h1>
                    ...
                    <form method="post" class="mb-4">
                        <div class="form-group">
                            ...
                            <select id="category" name="category" class="form-control" required>
                                ...
                                <option value="desglose_movimiento">Desglose de Movimiento</option>
                                <option value="ubicacion">Ubicación</option>
                                <option value="lugar_prod">Lugar de Producción</option>
...
document.getElementById('remove_category').addEventListener('change', function() {
    ...
    // Obtener las opciones de la categoría seleccionada (simulado)
    // En una implementación real, podrías hacer una llamada AJAX o tener los datos en JavaScript
